...
const AddCardDetailsScreen = () => {
  ...
  const [elevationBenchmark, setElevationBenchmark] = useState("");
  return <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.fullInputs}>
          <View style={styles.column}>
            <View style={styles.inputContainer}>
              <Text style={styles.inputText}>{"Easting (X) (M)"}</Text>
              <TextInput style={styles.input} onChangeText={text => setEasting(text)} value={easting} placeholder="Enter Easting (X) (M)" placeholderTextColor="#9B9B9B" autoCapitalize="none" autoCorrect={false} />
            </View>
            <View style={styles.inputContainer}>
              <Text style={styles.inputText}>{"Northing (Y) (M)"}</Text>
              <TextInput style={styles.input} onChangeText={text => setNorthing(text)} value={northing} placeholder="Enter Northing (Y) (M)" placeholderTextColor="#9B9B9B" autoCapitalize="none" autoCorrect={false} />
            </View>
          </View>
          <View style={styles.column}>
            <View style={styles.inputContainer}>
              <Text style={styles.inputText}>{"Elevation (ft)"}</Text>
              <TextInput style={styles.input} onChangeText={text => setElevation(text)} value={elevation} placeholder="Enter Elevation (ft)" placeholderTextColor="#9B9B9B" autoCapitalize="none" autoCorrect={false} />
            </View>
            <View style={styles.inputContainer}>
              <Text style={styles.inputText}>{"Elevation Benchmark/Datum"}</Text>
              <TextInput style={styles.input} onChangeText={text => setElevationBenchmark(text)} value={elevationBenchmark} placeholder="Enter Elevation Benchmark/Datum" placeholderTextColor="#9B9B9B" autoCapitalize="none" autoCorrect={false} />
            </View>
          </View>
        </View>
