"""
Django settings for rslog_offline_42106 project.
...
ROOT_URLCONF = 'rslog_offline_42106.urls'
...
WSGI_APPLICATION = 'rslog_offline_42106.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rslog_offline_42106 API",
    "DESCRIPTION": "API documentation for rslog_offline_42106 App",
    "VERSION": "v1",
}
